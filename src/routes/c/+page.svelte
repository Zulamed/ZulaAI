<script lang="ts">
	...
	function closeRulesPopup() {
		let rulesPopup = document.querySelector(".popup-overlay") as HTMLElement;

		let rulesPopupInfo = document.querySelector(".rules-overlay") as HTMLElement;

		if (checkboxChecked) {
			rulesPopup.style.display = "none";
		}

		rulesPopupInfo.style.display = "none";
	}

	function openRulesPopup() {
		let rulesPopup = document.querySelector(".rules-overlay") as HTMLElement;
	...
	<div class="start-screen">
		<div class="popup-overlay">
			<div class="popup">
				...
				<button on:click={closeRulesPopup} class:disabled={!checkboxChecked} class="popup-btn rules">Schließen</button>
			</div>
		</div>
		...
		<div class="top-part">
			<a href="/c">
				<img src="/logo/Mobilelogo.webp" class="mobile-logo" alt="ZulaMed" />
			</a>
		</div>
		<div class="middle-part">
			<div class="middle-part-text">
				...
				<div class="info-wrapper">
					<p class="home-sm-text">Beginnen Sie jetzt eine Simulation mit ZulaMed</p>
		...
		<div class="bottom-part">
			<Terms textDisplay="none" textColor="#00BCA1" />
		</div>
	</div>
</div>
...
<style>
	...
	.popup-btn.rules:hover,
	.popup-btn.rules:active {
